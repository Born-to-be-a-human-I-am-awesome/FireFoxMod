...
//便捷式火焰弹：投掷物渲染类
public class RenderPortableFireCharge extends EntityRenderer<EntityPortableFireCharge>{
    ...
    public RenderPortableFireCharge(EntityRendererProvider.Context manager) {
    ...
    protected int getSkyLightLevel(EntityPortableFireCharge p_239381_1_, BlockPos p_239381_2_) {
        return 1;
    }
    @Override
    public ResourceLocation getTextureLocation(EntityPortableFireCharge p_110775_1_) {
        return TEXTURE;
    }

    public void render(EntityPortableFireCharge entityIn, float entityYaw, float partialTicks, PoseStack poseStackIn, MultiBufferSource bufferIn, int packedLightIn) {
