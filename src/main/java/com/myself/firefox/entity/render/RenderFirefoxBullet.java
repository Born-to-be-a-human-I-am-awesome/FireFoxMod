...
//import com.myself.firefox.entity.model.ModelMoSpitter;
...
//火狐子弹：投掷物渲染类
public class RenderFirefoxBullet extends EntityRenderer<EntityFirefoxBullet>{
    //指定我们的投掷物的皮肤，一般是我们blockbench中的那张贴图(第一步中的贴图)
    public static final ResourceLocation TEXTURE = new ResourceLocation(ModMain.MOD_ID ,"textures/entity/moreau.png");
    ...
    public RenderFirefoxBullet(EntityRendererProvider.Context manager) {
    ...
    protected int getSkyLightLevel(EntityFirefoxBullet p_239381_1_, BlockPos p_239381_2_) {
        return 1;
    }
    @Override
    public ResourceLocation getTextureLocation(EntityFirefoxBullet p_110775_1_) {
        return TEXTURE;
    }

    public void render(EntityFirefoxBullet entityIn, float entityYaw, float partialTicks, PoseStack poseStackIn, MultiBufferSource bufferIn, int packedLightIn) {
